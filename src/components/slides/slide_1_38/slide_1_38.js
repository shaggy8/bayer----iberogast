...
import './slide_1_38.css';
import Panel from '../../panel/panel.js';
import Button from '../../button/button.js';

export default class slide_1_38 extends Slide {
  render() { 
    return (
      <div className='slide slide_1_38' ref='slide_1_38' data-state={this.state.slidestate}>
        ...
        <div className='pointer_to_stomach_5' />
        <div className='pointer_to_stomach_6' />
