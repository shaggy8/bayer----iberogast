...
import './slide_1_40.css';
import Panel from '../../panel/panel.js';
import Button from '../../button/button.js';

export default class slide_1_40 extends Slide {

  render() { 
    return (
      <div className='slide slide_1_40' ref='slide_1_40' data-state={this.state.slidestate}>
        ...
        <div className='pointer_to_guts_before' />
        <div className='pointer_to_guts_after' />
